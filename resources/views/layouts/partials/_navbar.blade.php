<nav class="navbar fixed-top navbar-expand-md">
    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="{{ route('admin.apartments.index') }}">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item dropdown d-flex">
                        <i id="user" class="bi bi-person-circle d-inline-block"
                        ...
                        <div id="dropdown-nav" class="dropdown-menu dropdown-menu-right dropdown-menu-dark">
